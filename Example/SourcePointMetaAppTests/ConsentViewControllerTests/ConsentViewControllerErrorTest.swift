//
//  CCPAConsentViewControllerErrorTest.swift
...
class CCPAConsentViewControllerErrorTest: XCTestCase {
    
    var consentViewControllerError: CCPAConsentViewControllerError?
    
    override func setUp() {
        consentViewControllerError = CCPAConsentViewControllerError()
    }
    ...
    func testPropertyIDNotFound() {
        ...
        if errorObject.description == "Could not find a property with name mobile.demo for the account id 212" {
