//
//  CCPAConsentViewControllerTest.swift
//  CCPAConsentViewControllerTests
//
...
class CCPAConsentViewControllerTest: XCTestCase, ConsentDelegate {
    ...
    override func setUp() {
        readDataFromPlist()
        consentViewController = try! CCPAConsentViewController(accountId: accountId, propertyId: propertyId, property: property, PMId: pmId, campaign: campaign, showPM: showPM,consentDelegate: self)
    }
    ...
    func testSetSubjectToGDPR() {
        ...
        if UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_SUBJECT_TO_GDPR) != nil {
            if UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_SUBJECT_TO_GDPR) == "0" || UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_SUBJECT_TO_GDPR) == "1"  {
    ...
    func testStoreIABVars() {
        ...
        let iABvar = UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_PARSED_PURPOSE_CONSENTS)
        if iABvar != nil {
    ...
    func testClearAllConsentDataMethodForEuConsent() {
        ...
        let euConsentKey = UserDefaults.standard.string(forKey: CCPAConsentViewController.EU_CONSENT_KEY)
        if euConsentKey == nil {
    ...
    func testClearAllConsentDataMethodForConsentUUID() {
        consentViewController?.clearAllConsentData()
        let consentUUIDKey = UserDefaults.standard.string(forKey: CCPAConsentViewController.CONSENT_UUID_KEY)
    ...
    func testClearAllConsentDataMethodForIABConsentParsedPurposeConsents() {
        consentViewController?.clearAllConsentData()
        let iABConsentParsedPurposeConsents = UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_PARSED_PURPOSE_CONSENTS)
    ...
    func testClearAllConsentDataMethodForIABConsentParsedVendorConsents() {
        consentViewController?.clearAllConsentData()
        let iABConsentParsedVendorConsents = UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_PARSED_VENDOR_CONSENTS)
    ...
    func testClearAllConsentDataMethodForIABConsentCMPPresent() {
        consentViewController?.clearAllConsentData()
        let iABConsentCMPPresent = UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_CMP_PRESENT)
    ...
    func testClearAllConsentDataMethodForIABConsentSubjectToGDPR() {
        consentViewController?.clearAllConsentData()
        let iABConsentSubjectToGDPR = UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_SUBJECT_TO_GDPR)
    ...
    func testClearAllConsentDataMethodForIABConsentConsentString() {
        consentViewController?.clearAllConsentData()
        let iABConsentConsentString = UserDefaults.standard.string(forKey: CCPAConsentViewController.IAB_CONSENT_CONSENT_STRING)
