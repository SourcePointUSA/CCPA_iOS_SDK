...
class PropertyListViewModel {
    ...
    func propertyDetails(atIndex index: Int) -> (PropertyDetailsModel?, String?) {
        if let _properties = properties, _properties.count > index {
            ...
            let propertyDataModel = PropertyDetailsModel(accountId: _properties[index].accountId, propertyId: _properties[index].propertyId, propertyName: _properties[index].propertyName, campaign: _properties[index].campaign!, privacyManagerId: _properties[index].privacyManagerId, creationTimestamp: _properties[index].creationTimestamp!, authId: _properties[index].authId)
